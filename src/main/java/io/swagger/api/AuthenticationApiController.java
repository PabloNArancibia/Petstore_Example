...
public class AuthenticationApiController implements AuthenticationApi {
    ...
    public ResponseEntity<LoginResponse> logUser(@Parameter(in = ParameterIn.DEFAULT, description = "Data access to log", required=true, schema=@Schema()) @Valid @RequestBody LoginRequest body) {
